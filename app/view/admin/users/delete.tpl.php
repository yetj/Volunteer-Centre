...
<form class="needs-validation" novalidate action="<?= adminURL('users', 'delete_post', ['id' => $member->id]) ?>" method="post">
  ...
  <div class="form-row">
    <div class="col-md-8 mb-3">
		<a class="btn btn-warning float-right" href="<?= adminURL('users', 'index') ?>">Anuluj</a>
