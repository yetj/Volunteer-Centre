<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	<h1 class="h2">Użytkownicy - edytuj użytkownika</h1>
</div>
			

<form class="needs-validation" action="<?= adminURL('users', 'edit_post', ['id' => $member->id, 'project' => $project]) ?>" method="post" novalidate>
<input type="hidden" name="id" value="<?= $member->id ?>">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <div class="input-group">
        ...
        <input type="email" class="form-control" id="validationEmail" placeholder="E-mail" value="<?= isset($post['email']) ? $post['email'] : $member->email ?>" aria-describedby="inputGroupPrepend" disabled>
  ...
  <div class="form-row">
  	...
  	<table class="table table-sm table-bordered">
  		...
  		<tbody>
  			<tr class="text-center">
  				<td><input type="checkbox" name="access[]" id="USERS" value="<?= MemberModel::PROJECT_ACCESS_USERS ?>" <?= $access[1] ? 'checked="checked"' : '' ?>></td>
  				<td><input type="checkbox" name="access[]" id="PAGES" value="<?= MemberModel::PROJECT_ACCESS_PAGES ?>" <?= $access[2] ? 'checked="checked"' : '' ?>></td>
  				<td><input type="checkbox" name="access[]" id="TEMPLATES" value="<?= MemberModel::PROJECT_ACCESS_TEMPLATES ?>" <?= $access[3] ? 'checked="checked"' : '' ?>></td>
  				<td><input type="checkbox" name="access[]" id="ACTIONS" value="<?= MemberModel::PROJECT_ACCESS_ACTIONS ?>" <?= $access[4] ? 'checked="checked"' : '' ?>></td>
  				<td><input type="checkbox" name="access[]" id="APPLICATIONS" value="<?= MemberModel::PROJECT_ACCESS_APPLICATIONS ?>" <?= $access[5] ? 'checked="checked"' : '' ?>></td>
  				<td><input type="checkbox" name="access[]" id="SETTINGS" value="<?= MemberModel::PROJECT_ACCESS_SETTINGS ?>" <?= $access[6] ? 'checked="checked"' : '' ?>></td>
  				<td><input type="checkbox" name="access[]" id="LOGS" value="<?= MemberModel::PROJECT_ACCESS_LOGS ?>" <?= $access[7] ? 'checked="checked"' : '' ?>></td>
  			</tr>
  		</tbody>
  	</table>
  	</div>
